...
output RX_BYPASS_DATA_N_1;
    ...
    wire GND_net, VCC_net, Y_I_INBUF_DIFF_MIPI_0_net, 
        ...
        HS_SEL_I_INBUF_DIFF_MIPI_1_net;
    
    IOD #( .DATA_RATE(456.0), .FORMAL_NAME("RXD%STATIC_DELAY"), .INTERFACE_NAME("RX_DDRX_B_G_C")
        ...
        , .RX_MODE(4'b1100), .EYE_MONITOR_MODE(1'b0), .DYN_DELAY_LINE_EN(1'b0)
        ...
        RX_DATA_1[1], RX_DATA_1[0], nc0, RX_BYPASS_DATA_1}), 
        .DELAY_LINE_OUT_OF_RANGE(), .TX_DATA({GND_net, GND_net, 
        GND_net, GND_net, GND_net, GND_net, GND_net, GND_net}), 
        .OE_DATA({GND_net, GND_net, GND_net, HS_SEL_1}), .RX_BIT_SLIP(
        ...
        GND_net), .RX_P(Y_I_INBUF_DIFF_MIPI_1_net), .RX_N(), 
        ...
        FIFO_RD_PTR[1], FIFO_RD_PTR[0]}), .TX(), .OE(
        HS_SEL_I_INBUF_DIFF_MIPI_1_net), .CDR_CLK(GND_net), 
    ...
    IOD #( .DATA_RATE(456.0), .FORMAL_NAME("RXD:NO_IOD_N_SIDE%STATIC_DELAY")
        ...
        RX_DATA_0[2], RX_DATA_0[1], RX_DATA_0[0], nc12, 
        RX_BYPASS_DATA_0}), .DELAY_LINE_OUT_OF_RANGE(), .TX_DATA({
        GND_net, GND_net, GND_net, GND_net, GND_net, GND_net, GND_net, 
        GND_net}), .OE_DATA({GND_net, GND_net, GND_net, HS_SEL_0}), 
