//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Sun Mar 22 14:44:09 2026
...
create_and_configure_core -core_vlnv {Actel:SystemBuilder:PF_SRAM_AHBL_AXI:1.2.116} -component_name {MSS_LSRAM} -params {\
...
// Component instances
//--------------------------------------------------------------------
//--------MSS_LSRAM_COREAXI4SRAM_0_COREAXI4SRAM   -   Actel:DirectCore:COREAXI4SRAM:3.0.102
MSS_LSRAM_COREAXI4SRAM_0_COREAXI4SRAM #( 
        ...
        .AXI4_IFTYPE_RD     ( 1 ),
        .AXI4_IFTYPE_WR     ( 1 ),
        .AXI4_READ_TIMEOUT  ( 80 ),
        .AXI4_WRITE_TIMEOUT ( 80 ),
        .ECC                ( 0 ),
        .FAMILY             ( 26 ),
        .HI_REL             ( 0 ),
        .MEM_DEPTH          ( 2048 ),
