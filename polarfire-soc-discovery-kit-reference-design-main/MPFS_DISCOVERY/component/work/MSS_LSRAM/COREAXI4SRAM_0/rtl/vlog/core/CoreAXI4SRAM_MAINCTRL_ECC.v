  ...
  generate
    ...
    begin
      ...
      begin
        ...
        else if(wr_req_gnt & ~wr_req_gnt_d)
        begin
          awready_mc    <= 1'b1;
          waddrchset_mc <= 1'b1;
        end
  ...
  generate
    ...
    begin
      ...
      begin
        ...
        else if(rd_req_gnt & ~rd_req_gnt_d)
        begin
          arready_mc    <= 1'b1;
          raddrchset_mc <= 1'b1;
        end
      ...
      begin
        ...
        begin
          ...
          begin
            if(ren_sc & (rdbeat_cnt == 1) & ~rlast_mc)
            begin
              rlast_mc <= 1'b1;
            end
            else if(rvalid_mc & RREADY_slvif)
      ...
      begin
        ...
        always @(*)
        begin
          if(ren_sc & (rdbeat_cnt == 1) & ~rlast_mc_r)
          begin
            rlast_mc = 1'b1;
          end
      ...
      begin
        ...
        begin
          ...
          begin
            if(rvalid_mc && RREADY_slvif && rdbeat_cnt != 'h0)
            begin
