...
//
// *********************************************************************
module MSS_LSRAM_COREAXI4SRAM_0_CoreAXI4SRAM_MAINCTRL_RT(
    ACLK,
    RESETN,
    ...
    begin
      ...
      begin
        if ((aresetn == 1'b0) || (sresetn == 1'b0))
          wready_mc <= 1'b0;
        else if (fault_det & fault_det_timer_write) // changed
          wready_mc <= 1'b1;
        else if(wrdone)
          wready_mc <= 1'b0;
      ...
      begin
        ...
        else if((bvalid_mc & BREADY_slvif) || (fault_det & fault_det_timer_write)) // changed
        begin
          awready_mc    <= 1'b1;
          waddrchset_mc <= 1'b1;
        end
        else if(AWVALID_slvif)
        begin
          awready_mc    <= 1'b0;
          waddrchset_mc <= 1'b0;
        end
  ...
  generate
    ...
    begin
      ...
      begin
        ...
        else if((rvalid_mc & rlast_mc & RREADY_slvif) || (fault_det & fault_det_timer_read)) // changed
        begin
          arready_mc    <= 1'b1;
          raddrchset_mc <= 1'b1;
        end
        else if(ARVALID_slvif)
        begin
          arready_mc    <= 1'b0;
          raddrchset_mc <= 1'b0;
        end
      ...
      begin
        ...
        begin
          ...
          begin
            if(ren_sc & (rdbeat_cnt <= 1) & ~rlast_mc) // changed
            begin
              rlast_mc <= 1'b1;
            end
            else if(rvalid_mc & RREADY_slvif)
      ...
      begin
        ...
        always @(*)
        begin
          if(ren_sc & (rdbeat_cnt <= 1) & ~rlast_mc_r) // changed
          begin
            rlast_mc = 1'b1;
          end
        ...
        always @(*)
        begin
          /*if(rvalid_mc & RREADY_slvif & rlast_mc) // changed
          begin
            ren_sc = 1'b0;
          end
      ...
      begin
        ...
        begin
          ...
          begin
            if(rvalid_mc && RREADY_slvif && rdbeat_cnt > 'h0) // changed 'h0 to 'h1FF
            begin
          ...
          begin
            if(ren_sc && rdbeat_cnt > 'h0)// changed 'h0 to 'h1FF
            begin
              rdbeat_cnt <= rdbeat_cnt - 'h1;
            end
          end
  ...
  generate
    ...
    begin
      ...
      begin
        if ((aresetn == 1'b0) || (sresetn == 1'b0))
          wr_req_inprog <= 1'b0;
        else if (BREADY_slvif & bvalid_mc)
          wr_req_inprog <= 1'b0;
        else if (AWVALID_slvif)
          wr_req_inprog <= 1'b1;
      end
      ...
      begin
        if ((aresetn == 1'b0) || (sresetn == 1'b0))
          rd_req_inprog <= 1'b0;
        else if (RREADY_slvif & rvalid_mc & rlast_mc)
          rd_req_inprog <= 1'b0;
        else if (ARVALID_slvif)
          rd_req_inprog <= 1'b1;
      end
